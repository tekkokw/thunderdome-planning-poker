...
func New(apiService Service, FSS fs.FS, HFS http.FileSystem) *Service {
	...
	router.Handle("GET "+prefix+"/api/admin/service-accounts", a.userOnly(a.adminOnly(a.handleListServiceAccounts())))
	router.Handle("POST "+prefix+"/api/admin/service-accounts", a.userOnly(a.adminOnly(a.handleCreateServiceAccount())))
	router.Handle("DELETE "+prefix+"/api/admin/service-accounts/{id}", a.userOnly(a.adminOnly(a.handleDeleteServiceAccount())))
